...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?= $uri[2] == 'anggota' ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url("anggota"); ?>">
          <i class="fas fa-fw fa-users"></i>
          <span>Data Anggota</span></a>
      </li>

      <li class="nav-item <?= $uri[2] == 'masuk' ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url("masuk"); ?>">
          <i class="fas fa-fw fa-door-open"></i>
          <span>Data Masuk Kost</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link keluar" href="#">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <button class="btn btn-danger keluar"><i class="fas fa-sign-out-alt"></i> Logout</button>
